...
<html <?php language_attributes(); ?>>
  ...
  <body <?php body_class(); ?>>
    ...
    ?>
    <?php if(is_page_template('template-acct-partner.php')) { ?>
    ...
    <div class="container">
      <div class="row section-break">
        <div class="col-sm-12 col-lg-4">
          <img class="xl-streamline-illustration center" src="https://growthandpurpose.com/wp-content/uploads/37-alarm-clock.svg" alt="alarm clock wake up illustration">
        </div>
    ...
    <div class="container">
      <div class="row section-break">
        ...
        <div class="col-sm-12 col-lg-8 col-lg-offset-2">
          <blockquote>Alex is awesome. I really appreciate him helping me reach my fitness goal in 24 days. It was amazing having him invest in me and help me stay on track. I highly recommend working with him. <cite> Tom Smith</cite> </blockquote>
        </div>
      </div>
    </div>
    <div class="container">
      <div class="row section-break">
        ...
        <div class="col-sm-12 col-lg-4">
          <img class="sm-streamline-illustration center" src="https://growthandpurpose.com/wp-content/uploads/28-programming-approve-check.svg" alt="alarm clock wake up illustration">
        ...
        <div class="col-sm-12 col-lg-4">
          <img class="sm-streamline-illustration center" src="https://growthandpurpose.com/wp-content/uploads/14-business-goal.svg" alt="alarm clock wake up illustration">
        ...
        <div class="col-sm-12 col-lg-4">
          <img class="sm-streamline-illustration center" src="https://growthandpurpose.com/wp-content/uploads/23-business-plan-strategy.svg" alt="alarm clock wake up illustration">
