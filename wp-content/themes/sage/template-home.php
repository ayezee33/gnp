...
<?php while (have_posts()) : the_post(); ?>
  ...
  <div class="row section-break">
    <div class="col-sm-12 col-lg-6">
      <img class="xl-streamline-illustration center mt2 mb2" src="https://growthandpurpose.com/wp-content/uploads/illustration@2x.png" alt="launch idea illustration">
    </div>
    <div class="col-sm-12 col-lg-6">
   ...
   <div class="row section-break">
     ...
     <div class="col-sm-12 col-lg-6">
       <img class="xl-streamline-illustration center mt2" src="https://growthandpurpose.com/wp-content/uploads/07-Hand-Shaking.png" alt="drowning illustration">
    </div>
   </div>
   <div class="row">
