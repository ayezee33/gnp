  ...
  <div class="row section-break">
    <div class="col-sm-12 col-lg-8 col-lg-offset-2">
      <img class="streamline-illustration center mb2" src="http://growthandpurpose.com/wp-content/uploads/illustration@2x.png" alt="launch idea illustration">
       ...
       <a class="btn btn-outline btn-center" href="#start">Get Started</a>
      </div>
   </div>
   <div class="row section-break">
     <div class="col-sm-12 col-lg-6">
       ...
       <a class="btn btn-success btn-lg" href="#start">Get Back On Track Today!</a>
     </div>
     <div class="col-sm-12 col-lg-6">
       <img class="streamline-illustration center mb2" src="http://growthandpurpose.com/wp-content/uploads/drowning-illustration@2x.png" alt="drowning illustration">
    </div>
   </div>
   <div class="row">
     <div class="col-sm-12 col-lg-8 col-lg-offset-2">
